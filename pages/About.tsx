  ...
  return (
    <React.Fragment>
      ...
      <Slider pageColor="bg-light-blue">
        <section className="full-w-h py-16 sm:p-16 md:p-24 lg:p-48">
          <div className="full-w-h flex flex-col lg:flex-row gap-16">
            <article className="lg:basis-1/2">
              <h2 className="text-3xl font-bold">Hi there,</h2>
              <p className="pt-32 font-medium text-xl">
                I'm Robert Tran, a junior web developer with one year
                experience.
              </p>
              <p className="pt-16 font-medium text-xl">
                I'm passionate in making web application with different
                libraries such as React.js, Tailwindcss, MUI, Three.js.
                Currently I'm learning about back-end development including
                Node.js, Express.js, Firebase and also doing freelance work. I'm
                looking for an opportunity to improve my web development skills
